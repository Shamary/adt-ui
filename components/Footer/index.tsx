      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-48 md:w-1/2 lg:w-4/12 xl:w-5/12">
            ...
            <div className="w-full px-16 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-xs text-body-color dark:text-white">
              {/* Template by UIdeck and <a href="https://nextjstemplates.com" rel="nofollow noopener">Next.js Templates</a> */}
              © {new Date().getFullYear()} ADT. All rights reserved.
            </p>
          </div>
        </div>
